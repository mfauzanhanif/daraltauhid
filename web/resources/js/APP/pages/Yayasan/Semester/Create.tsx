...
import { index as semestersIndex, create as semestersCreate, store as semestersStore } from '@/routes/semesters';
...
export default function SemesterCreate({ academicYears = [] }: Props) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Tambah', href: semestersCreate.url(code) },
    ];
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-6 p-6">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold">Tambah Semester</h1>
                        <p className="text-muted-foreground">Buat periode semester baru</p>
                    </div>
                </div>
